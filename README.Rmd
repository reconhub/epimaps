...
This package provides a set of tools and wrappers useful for mapping infectious
diseases.
...
*epimaps* is featured on the RECON website for map resources:
http://gisfirstaid.netlify.com/
